...
width, height = 50, 50
PATH_img = ".\\car-slot-detection\\data_sampleVideo\\presentasi\\CAM-81.jpg"
...
def mouseClick(events, x, y, flags, params):
	...
	with open(PATH_pos+'titik_ROI_Full81', 'wb') as f:
	...
	if len(posList) != 0 and len(posList)%4 == 0:		
		...
		with open(PATH_pos+'ROI_Full81', 'wb') as f:
			pickle.dump(pts_poly, f)


# =====================================================================
try:
	with open(PATH_pos+'titik_ROI_Full81', 'rb') as f:
...
while True:
	...
	# Anotasi ROI polygon
	if len(posList) != 0 and len(posList)%4 == 0:		
		with open(PATH_pos+'ROI_Full81', 'rb') as f:
	...
	cv2.imshow("ROI Full CAM81", img)
	cv2.setMouseCallback("ROI Full CAM81", mouseClick)
	k = cv2.waitKey(10)
	# Exit camera
	if k == 27:
