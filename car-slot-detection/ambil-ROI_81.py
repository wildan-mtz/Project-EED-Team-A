...
def mouseClick(events, x, y, flags, params):
	...
	with open(PATH_pos+'titik_koordinat_81', 'wb') as f:
	...
	if len(posList) != 0 and len(posList)%4 == 0:		
		...
		with open(PATH_pos+'titik_polygon_81', 'wb') as f:
			pickle.dump(pts_poly, f)


# =====================================================================
try:
	with open(PATH_pos+'titik_koordinat_81', 'rb') as f:
...
while True:
	...
	# Anotasi ROI polygon
	if len(posList) != 0 and len(posList)%4 == 0:		
		with open(PATH_pos+'titik_polygon_81', 'rb') as f:
	...
	cv2.imshow("ROI CAM81", img)
	cv2.setMouseCallback("ROI CAM81", mouseClick)
	k = cv2.waitKey(10)
	# Exit camera
	if k == 27:
